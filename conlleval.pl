#!/usr/bin/env perl
# This code was adapted from http://www.cnts.ua.ac.be/conll2000/chunking/output.html by
# Jose Alberto Esquivel Patiño for Name Entity Recognition evaluation.l
...
my $delimiter = "\s";     # field delimiter
...
if (not $latex) {
   ...
   printf "processed $tokenCounter tokens with $foundCorrect entities; ";
   printf "found: $foundGuessed entities; correct: $correctChunk.\n";
   if ($tokenCounter>0) {
